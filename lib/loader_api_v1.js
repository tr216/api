                ...
                if(!err){
                    LoadSystemModules((err)=>{
                        if(!err){
                            ...
                            console.log('Etulia Cloud API system V1 loaded.');
                        }else{
        ...
        for (var i = 0; i < l; i++) {
            ...
            if(!fs.statSync(f).isDirectory()){
                ...
                if (apiName != '' && (apiName + suffix) == fileName) {
                    ...
                    console.log('api ' + apiName.blue + ' loaded.');
                }
            }
        }
        cb(null);
        ...
        for (var i = 0; i < l; i++) {
            ...
            if(!fs.statSync(f).isDirectory()){
                ...
                if (apiName != '' && (apiName + suffix) == fileName) {
                    ...
                    console.log('api repo ' + apiName.blue + ' loaded.');
                }
            }
        }
        cb(null);
        ...
        for (var i = 0; i < l; i++) {
            ...
            if(!fs.statSync(f).isDirectory()){
                ...
                if (apiName != '' && (apiName + suffix) == fileName) {
                    ...
                    console.log('api system ' + apiName.blue + ' loaded.');
                }
            }
        }
        cb(null);
