                ...
                if(!err){
                    LoadSystemModules((err)=>{
                        if(!err){
                            ...
                            eventLog('Etulia Cloud API system V1 loaded.');
                        }else{
        ...
        for (var i = 0; i < l; i++) {
            ...
            if(!fs.statSync(f).isDirectory()){
                ...
                if (apiName != '' && (apiName + suffix) == fileName) {
                    ...
                    eventLog('api ' + apiName.blue + ' loaded.');
                }
            }
        }
        cb(null);
        ...
        for (var i = 0; i < l; i++) {
            ...
            if(!fs.statSync(f).isDirectory()){
                ...
                if (apiName != '' && (apiName + suffix) == fileName) {
                    ...
                    eventLog('api repo ' + apiName.blue + ' loaded.');
                }
            }
        }
        cb(null);
        ...
        for (var i = 0; i < l; i++) {
            ...
            if(!fs.statSync(f).isDirectory()){
                ...
                if (apiName != '' && (apiName + suffix) == fileName) {
                    ...
                    eventLog('api system ' + apiName.blue + ' loaded.');
                }
            }
        }
        cb(null);
