...
exports.e_invoice2xml=function(jsObject){
    jsObject=exports.deleteObjectFields(jsObject,["_id","createdDate","modifiedDate","deleted","__v","eIntegrator",'ioType']);
    ...
    var xmlString=js2xmlparser.parse('Invoice', obj, options);
